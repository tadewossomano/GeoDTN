...
R=a1+h1+v1+d1;
figure;imshow(R, []);title('before thresholding and amplifying,shifting');
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
[i j]=size(h1);
X=imresize(X,[i j]);
psnr1=zeros(4,1);
...
v1t=scl*v1;
d1t=scl*d1;
cod_h115=circshift(h1t,[1 -1]);
cod_h125=circshift(h1t,[2 -2]);
cod_h155=circshift(h1t,[5 -5]);
cod_h1105=circshift(h1t,[10 -10]);
cod_h1205=circshift(h1t,[20 -20]);
cod_v115=circshift(v1t,[1 -1]);
cod_v125=circshift(v1t,[2 -2]);
cod_v155=circshift(v1t,[5 -5]);
cod_v1105=circshift(v1t,[10 -10]);
cod_v1205=circshift(v1t,[20 -20]);
cod_d115=circshift(d1t,[1 -1]);
cod_d125=circshift(d1t,[2 -2]);
cod_d155=circshift(d1t,[5 -5]);
cod_d1105=circshift(d1t,[10 -10]);
cod_d1205=circshift(d1t,[20 -20]);
Rc1=a1+h1t+v1t+d1t;
...
Rcs20=a1+cod_h1205+cod_v1205+cod_d1205;%shift by 20 

figure;
imshow(Rc1,[]);
title(sprintf('threshold 5  and amplify =%2.1f%',scl));
pause;
imshow(Rcs1,[]);title(sprintf('threshold 5,shift 1  and amplify =%2.1f%',scl));
pause;
imshow(Rcs2,[]);title(sprintf('threshold 5,shift 2  and amplify =%2.1f%',scl));
pause;
imshow(Rcs5,[]);title(sprintf('threshold 5,shift 5  and amplify =%2.1f%',scl));
pause;
imshow(Rcs10,[]);title(sprintf('threshold 5,shift 10  and amplify =%2.1f%',scl));
pause;
imshow(Rcs20,[]);title(sprintf('threshold 5,shift 20  and amplify =%2.1f%',scl));
psnr1(plc,1)=PSNR(X,Rc1);
psnr115(plc,1)=PSNR(X,Rcs1);
psnr125(plc,1)=PSNR(X,Rcs2);
psnr155(plc,1)=PSNR(X,Rcs5);
psnr1105(plc,1)=PSNR(X,Rcs10);
psnr1205(plc,1)=PSNR(X,Rcs20);
plc=plc+1;
 end
 pause;
skl=[2 7 12 17];
...
v1t=scl*v1;
d1t=scl*d1;
cod_h1110=circshift(h1t,[1 -1]);
cod_h1210=circshift(h1t,[2 -2]);
cod_h1510=circshift(h1t,[5 -5]);
cod_h11010=circshift(h1t,[10 -10]);
cod_h12010=circshift(h1t,[20 -20]);
cod_v1110=circshift(v1t,[1 -1]);
cod_v1210=circshift(v1t,[2 -2]);
cod_v1510=circshift(v1t,[5 -5]);
cod_v11010=circshift(v1t,[10 -10]);
cod_v12010=circshift(v1t,[20 -20]);
cod_d1110=circshift(d1t,[1 -1]);
cod_d1210=circshift(d1t,[2 -2]);
cod_d1510=circshift(d1t,[5 -5]);
cod_d11010=circshift(d1t,[10 -10]);
cod_d12010=circshift(d1t,[20 -20]);
Rc1=a1+h1t+v1t+d1t;
...
pause;
imshow(Rcs1,[]);title(sprintf('threshold 10,shift 1  and amplify =%2.1f%',scl));
pause;
imshow(Rcs2,[]);title(sprintf('threshold 10,shift 2  and amplify =%2.1f%',scl));
pause;
imshow(Rcs5,[]);title(sprintf('threshold 10,shift 5  and amplify =%2.1f%',scl));
pause;
imshow(Rcs10,[]);title(sprintf('threshold 10,shift 10  and amplify =%2.1f%',scl));
pause;
imshow(Rcs20,[]);title(sprintf('threshold 10,shift 20  and amplify =%2.1f%',scl));
psnr10(plc,1)=PSNR(X,Rc1);
psnr1110(plc,1)=PSNR(X,Rcs1);
psnr1210(plc,1)=PSNR(X,Rcs2);
psnr1510(plc,1)=PSNR(X,Rcs5);
psnr11010(plc,1)=PSNR(X,Rcs10);
psnr12010(plc,1)=PSNR(X,Rcs20);
plc=plc+1;
 end
 pause;
skl=[2 7 12 17];
...
v1t=scl*v1;
d1t=scl*d1;
cod_h1120=circshift(h1t,[1 -1]);
cod_h1220=circshift(h1t,[2 -2]);
cod_h1520=circshift(h1t,[5 -5]);
cod_h11020=circshift(h1t,[10 -10]);
cod_h12020=circshift(h1t,[20 -20]);
cod_v1120=circshift(v1t,[1 -1]);
cod_v1220=circshift(v1t,[2 -2]);
cod_v1520=circshift(v1t,[5 -5]);
cod_v11020=circshift(v1t,[10 -10]);
cod_v12020=circshift(v1t,[20 -20]);
cod_d1120=circshift(d1t,[1 -1]);
cod_d1220=circshift(d1t,[2 -2]);
cod_d1520=circshift(d1t,[5 -5]);
cod_d11020=circshift(d1t,[10 -10]);
cod_d12020=circshift(d1t,[20 -20]);
...
pause;
imshow(Rcs1,[]);title(sprintf('threshold 20,shift 1  and amplify =%2.1f%',scl));
pause;
imshow(Rcs2,[]);title(sprintf('threshold 20,shift 2  and amplify =%2.1f%',scl));
pause;
imshow(Rcs5,[]);title(sprintf('threshold 20,shift 5  and amplify =%2.1f%',scl));
pause;
imshow(Rcs10,[]);title(sprintf('threshold 20,shift 10  and amplify =%2.1f%',scl));
pause;
imshow(Rcs20,[]);title(sprintf('threshold 20,shift 20  and amplify =%2.1f%',scl));
psnr20(plc,1)=PSNR(X,Rc1);
psnr1120(plc,1)=PSNR(X,Rcs1);
psnr1220(plc,1)=PSNR(X,Rcs2);
psnr1520(plc,1)=PSNR(X,Rcs5);
psnr11020(plc,1)=PSNR(X,Rcs10);
psnr12020(plc,1)=PSNR(X,Rcs20);
plc=plc+1;
 end
 pause;
skl=[2 7 12 17];
...
xlabel('amplification');
ylabel('psnr byt hreshold  20 & shift 5');
pause;
